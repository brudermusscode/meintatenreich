...
$ptit = 'Datenschutzbestimmungen';
$pid = "intern:privacy";

include_once $sroot . "/intern/assets/templates/head.php";
include_once $sroot . "/intern/assets/templates/header.php";
...
<div class="main-content">
    <div class="inr">
        ...
        <p>
            <span class="tsmcontroller">Kerstin Giese<br>
                Windmühlenweg 29<br>
                49456 Bakum/Hausstette<br>
                Deutschland<br>
                <br>
                E-Mailadresse: meintatenreich@onlinehome.de<br>
                Geschäftsführer/Inhaber: Kerstin Giese<br>
                Link zum Impressum: <a href="<?php echo $url["intern"]; ?>/imprint"><?php echo $url["intern"]; ?>/imprint</a></span>
        </p>
        ...
        <h3 id="cookies">Cookies und Widerspruchsrecht bei Direktwerbung</h3>
        ...
        <p>
            <span class="ts-muster-content">Wir unterhalten Onlinepräsenzen innerhalb sozialer Netzwerke und Plattformen, um mit den dort aktiven Kunden, Interessenten und Nutzern kommunizieren und sie dort über unsere Leistungen informieren zu können.<br>
                <br>
                ...
                <br>
                - Soundcloud (SoundCloud Limited, Rheinsberger Str. 76/77, 10115 Berlin, Deutschland) - Datenschutzerklärung/ Opt-Out: <a target="_blank" href="https://soundcloud.com/pages/privacy">https://soundcloud.com/pages/privacy</a>.</span>
        </p>
        ...
        <p>
            <span class="ts-muster-content">Wir binden die Schriftarten ("Google Fonts") des Anbieters Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA, ein. Datenschutzerklärung: <a target="_blank" href="https://www.google.com/policies/privacy/">https://www.google.com/policies/privacy/</a>, Opt-Out: <a target="_blank" href="https://adssettings.google.com/authenticated">https://adssettings.google.com/authenticated</a>.</span>
        </p>
        ...
        <div style="background:rgba(0,0,0,.04);padding:24px;text-align:center;margin-top:42px;">
