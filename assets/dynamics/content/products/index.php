...
if (isset($_REQUEST['action'], $_REQUEST['order'])) {
    ...
    switch ($action) {
        ...
        case 'get-category':
            ...
            $dropdownCategoryText = $category->name;
        ...
        <div data-element="select" data-action="products:sort,category">
            ...
            <div class="list mshd-2 rd3 tran-all-cubic">
                <ul>
                    ...
                    foreach ($getProductCategories as $productCategory) {

                    ?>

                        <li data-json='[{"id":"<?php echo $productCategory->id; ?>"}]'><?php echo $productCategory->name; ?></li>
